const CACHE_NAME = "orion-0-1-0-development-12-21-static-v1";
const STATIC_PATHS = [
  "./",
  "./assets/institutions-v2/agibank.svg",
  "./assets/institutions-v2/banco-bv.svg",
  "./assets/institutions-v2/banco-do-brasil.svg",
  "./assets/institutions-v2/banco-do-nordeste.svg",
  "./assets/institutions-v2/banco-original.svg",
  "./assets/institutions-v2/banco-pan.svg",
  "./assets/institutions-v2/banestes.svg",
  "./assets/institutions-v2/banrisul.svg",
  "./assets/institutions-v2/bmg.svg",
  "./assets/institutions-v2/bradesco.svg",
  "./assets/institutions-v2/brb.svg",
  "./assets/institutions-v2/btg.svg",
  "./assets/institutions-v2/c6-bank.svg",
  "./assets/institutions-v2/caixa.svg",
  "./assets/institutions-v2/caju.svg",
  "./assets/institutions-v2/custom.svg",
  "./assets/institutions-v2/daycoval.svg",
  "./assets/institutions-v2/inter.svg",
  "./assets/institutions-v2/itau.svg",
  "./assets/institutions-v2/mercado-pago.svg",
  "./assets/institutions-v2/neon.svg",
  "./assets/institutions-v2/next.svg",
  "./assets/institutions-v2/nubank.svg",
  "./assets/institutions-v2/pagbank.svg",
  "./assets/institutions-v2/picpay.svg",
  "./assets/institutions-v2/rico.svg",
  "./assets/institutions-v2/safra.svg",
  "./assets/institutions-v2/santander.svg",
  "./assets/institutions-v2/sicoob.svg",
  "./assets/institutions-v2/sicredi.svg",
  "./assets/institutions-v2/will-bank.svg",
  "./assets/institutions-v2/xp.svg",
  ...
  "./dist/ui/shell.js",
  "./dist/ui/v2/accounts-manager.js",
  "./dist/ui/v2/app-preview.js",
  "./dist/ui/v2/home.js",
  "./dist/ui/v2/institution-brand.js",
  "./dist/ui/v2/movement-icon.js",
  "./dist/ui/v2/movements.js",
  "./dist/ui/v2/shell.js",
  "./index.html",
